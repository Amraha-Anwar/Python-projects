...
JOKE : str = "Panaversity GPT - Sophia is heading out to the grocery store. A programmer tells her: get a liter of milk, and if they have eggs, get 12. Sophia returns with 13 liters of milk. The programmer asks why and Sophia replies: 'because they had eggs'... :D"
PROMPT: str = "What do you want? "
SORRY_MESSAGE : str = " Sorry I only tell jokes"

def make_jokes(user_response: str):
    if user_response == "joke":
